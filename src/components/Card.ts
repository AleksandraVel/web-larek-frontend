...
//Класс представляет собой карточку товара в галерее.
...
//Класс наследует от Card и предназначен для создания элемента магазина
...
//Класс наследует от Card и добавляет описание товара
